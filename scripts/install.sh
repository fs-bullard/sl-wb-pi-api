...
# Step 4: Skip USB device permissions configuration
echo "Step 4: USB device permissions..."
echo ""
echo "  Skipping udev rule creation (can cause 'resource busy' errors)"
echo "  If you get permission errors, run the service with sudo"
echo "  or manually configure USB permissions"
echo ""
